...
function galakong.startplugin()
	...
	local logo_palette = {}	
	logo_palette[" "] = 0xff125e5e
	logo_palette["!"] = 0xff79a39b
	logo_palette["#"] = 0xff850000
	logo_palette["$"] = 0xfffb0c09
	logo_palette["%"] = 0xfff85328
	logo_palette["&"] = 0xffdf962d
	logo_palette["'"] = 0xfffafaf9
	...
	function main()
		if cpu ~= nil then
			...
			-- display GalaKong logo on coin entry and how high screens
			if mode2 == 0x01 or mode2 == 0x0a then
				draw_logo(234, 35)
			end
	...
	function draw_logo(pos_y, pos_x)
